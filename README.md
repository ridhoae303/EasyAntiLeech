...
It is a lightweight welcome/credit dialog made for modders who want to show the original creator name clearly inside the app. EAL handles the signature check; WelcomeDialog handles the creator intro. They work nicely together, and yes, this is absolutely a shameless plug for my own repo. 😄❤️
